...
export default function (eleventyConfig) {
  ...
  // Distinct GA4 property from the main site and from Clara's subsite — its own
  // measurement ID, injected at build time from NAOMI_GA_MEASUREMENT_ID. Unset
  // disables analytics (and the consent banner) entirely, exactly as on the
  // parent site.
  eleventyConfig.addGlobalData("analytics", () => ({
    measurementId: process.env.NAOMI_GA_MEASUREMENT_ID || null,
  }));
